...
class Controller:
    ...
    def read_cluster_statistics_and_update_priorities(self):
        ...
        entries = self.controller.client.bm_mt_get_entries(0,"MyIngress.do_bytes_count")
        for entry in entries:
            # key = entry[0]
            # data = entry[1]
            # qid = key['queue_id']['value']
            qid = int.from_bytes(entry.match_key[0].exact.key, 'big')
            counter_value = self.controller.register_read('MyIngress.bytes_counter', 0)
        ...
        for cluster in self.cluster_list:
            ...
            # ])
            self.controller.table_modify_match("MyIngress.cluster_to_prio", 
                                         'set_qid', 
                                         [str(cluster.get_id())],
                                         [str(cluster.get_priority())])
        ...
        self.controller.register_reset("MyIngress.bytes_counter")
        print("------------------------------------------------------")
    ...
    def reset_clusters_and_clear_counters(self):
        ...
        if self.init: 
            ...
            self.controller.register_write("MyIngress.cluster1_dst0_min", 2, 255)
            self.controller.register_write("MyIngress.cluster1_dst0_max", 2, 0)
            self.controller.register_write("MyIngress.cluster1_dst1_min", 2, 255)
            self.controller.register_write("MyIngress.cluster1_dst1_max", 2, 0)
            self.controller.register_write("MyIngress.cluster1_dst2_min", 2, 255)
            self.controller.register_write("MyIngress.cluster1_dst2_max", 2, 0)
            self.controller.register_write("MyIngress.cluster1_dst3_min", 2, 255)
            self.controller.register_write("MyIngress.cluster1_dst3_max", 2, 0)
        
            self.controller.register_write("MyIngress.cluster2_dst0_min", 2, 255)
            self.controller.register_write("MyIngress.cluster2_dst0_max", 2, 0)
            self.controller.register_write("MyIngress.cluster2_dst1_min", 2, 255)
            self.controller.register_write("MyIngress.cluster2_dst1_max", 2, 0)
            self.controller.register_write("MyIngress.cluster2_dst2_min", 2, 255)
            self.controller.register_write("MyIngress.cluster2_dst2_max", 2, 0)
            self.controller.register_write("MyIngress.cluster2_dst3_min", 2, 255)
            self.controller.register_write("MyIngress.cluster2_dst3_max", 2, 0)

            self.controller.register_write("MyIngress.cluster3_dst0_min", 2, 255)
            self.controller.register_write("MyIngress.cluster3_dst0_max", 2, 0)
            self.controller.register_write("MyIngress.cluster3_dst1_min", 2, 255)
            self.controller.register_write("MyIngress.cluster3_dst1_max", 2, 0)
            self.controller.register_write("MyIngress.cluster3_dst2_min", 2, 255)
            self.controller.register_write("MyIngress.cluster3_dst2_max", 2, 0)
            self.controller.register_write("MyIngress.cluster3_dst3_min", 2, 255)
            self.controller.register_write("MyIngress.cluster3_dst3_max", 2, 0)

            self.controller.register_write("MyIngress.cluster4_dst0_min", 2, 255)
            self.controller.register_write("MyIngress.cluster4_dst0_max", 2, 0)
            self.controller.register_write("MyIngress.cluster4_dst1_min", 2, 255)
            self.controller.register_write("MyIngress.cluster4_dst1_max", 2, 0)
            self.controller.register_write("MyIngress.cluster4_dst2_min", 2, 255)
            self.controller.register_write("MyIngress.cluster4_dst2_max", 2, 0)
            self.controller.register_write("MyIngress.cluster4_dst3_min", 2, 255)
            self.controller.register_write("MyIngress.cluster4_dst3_max", 2, 0)

        else:
                # We can specified a desired cluster initialization
                self.controller.register_write("MyIngress.cluster1_dst0_min", 2, 0)
                self.controller.register_write("MyIngress.cluster1_dst0_max", 2, 255)
                self.controller.register_write("MyIngress.cluster1_dst1_min", 2, 0)
                self.controller.register_write("MyIngress.cluster1_dst1_max", 2, 255)
                self.controller.register_write("MyIngress.cluster1_dst2_min", 2, 0)
                self.controller.register_write("MyIngress.cluster1_dst2_max", 2, 127)
                self.controller.register_write("MyIngress.cluster1_dst3_min", 2, 0)
                self.controller.register_write("MyIngress.cluster1_dst3_max", 2, 127)

                self.controller.register_write("MyIngress.cluster2_dst0_min", 2, 0)
                self.controller.register_write("MyIngress.cluster2_dst0_max", 2, 255)
                self.controller.register_write("MyIngress.cluster2_dst1_min", 2, 0)
                self.controller.register_write("MyIngress.cluster2_dst1_max", 2, 255)
                self.controller.register_write("MyIngress.cluster2_dst2_min", 2, 0)
                self.controller.register_write("MyIngress.cluster2_dst2_max", 2, 127)
                self.controller.register_write("MyIngress.cluster2_dst3_min", 2, 128)
                self.controller.register_write("MyIngress.cluster2_dst3_max", 2, 255)

                self.controller.register_write("MyIngress.cluster3_dst0_min", 2, 0)
                self.controller.register_write("MyIngress.cluster3_dst0_max", 2, 255)
                self.controller.register_write("MyIngress.cluster3_dst1_min", 2, 0)
                self.controller.register_write("MyIngress.cluster3_dst1_max", 2, 255)
                self.controller.register_write("MyIngress.cluster3_dst2_min", 2, 128)
                self.controller.register_write("MyIngress.cluster3_dst2_max", 2, 255)
                self.controller.register_write("MyIngress.cluster3_dst3_min", 2, 0)
                self.controller.register_write("MyIngress.cluster3_dst3_max", 2, 127)

                self.controller.register_write("MyIngress.cluster4_dst0_min", 2, 0)
                self.controller.register_write("MyIngress.cluster4_dst0_max", 2, 255)
                self.controller.register_write("MyIngress.cluster4_dst1_min", 2, 0)
                self.controller.register_write("MyIngress.cluster4_dst1_max", 2, 255)
                self.controller.register_write("MyIngress.cluster4_dst2_min", 2, 128)
                self.controller.register_write("MyIngress.cluster4_dst2_max", 2, 255)
                self.controller.register_write("MyIngress.cluster4_dst3_min", 2, 128)
                self.controller.register_write("MyIngress.cluster4_dst3_max", 2, 255)

        # We set the initialization counter to 1 so that clusters are initialized
        self.controller.register_write("MyIngress.init_counter", 2, 1)
        self.controller.register_write("MyIngress.updateclusters_counter", 2, 0)
        ...
        self.controller.table_add("MyIngress.cluster_to_prio", 'set_qid', ['1'], ['1'])
        self.controller.table_add("MyIngress.cluster_to_prio", 'set_qid', ['2'], ['2'])
        self.controller.table_add("MyIngress.cluster_to_prio", 'set_qid', ['3'], ['3'])
        self.controller.table_add("MyIngress.cluster_to_prio", 'set_qid', ['4'], ['4'])
        
        self.controller.table_add("MyIngress.do_bytes_count", 'bytes_count', ['1'])
        self.controller.table_add("MyIngress.do_bytes_count", 'bytes_count', ['2'])
        self.controller.table_add("MyIngress.do_bytes_count", 'bytes_count', ['3'])
        self.controller.table_add("MyIngress.do_bytes_count", 'bytes_count', ['4'])
    ...
    def read_throughput(self, file_throughput_benign, file_throughput_malicious):
        ...
        read_timestamp = self.controller.register_read("MyEgress.timestamp", 0)
        ...
        # entries = self.controller.client.bm_mt_get_entries(0,"MyEgress.do_bytes_count_malicious_egress")
        # counts_malicious = self.controller.counter_read("MyEgress.bytes_counter_malicious_egress", 0)
        # for count in counts_malicious:
        #     count_malicious = count
        #     count_malicious_bits = int(count_malicious)*8
        # count_malicious_bits = 0
        # for entry in entries:
            # key = entry[0]
            # data = entry[1]
        count_malicious = self.controller.register_read("MyEgress.bytes_counter_malicious_egress", 2)
        count_malicious_bits = int(count_malicious)*8
        print("Count malicious bits: " + str(count_malicious_bits))
        ...
        # entries = self.controller.client.bm_mt_get_entries(0,"MyEgress.do_bytes_count_benign_egress")
        # counts_benign = self.controller.counter_read("MyEgress.bytes_counter_benign_egress", 0)
        # count_benign_bits = 0
        # for entry in entries:
        count_benign = self.controller.register_read("MyEgress.bytes_counter_benign_egress", 2)
        count_benign_bits = int(count_benign)*8
        print("Count benign bits: " + str(count_benign_bits))
        # for entry in entries:
        #     key = entry[0]
        #     data = entry[1]
    ...
    def __init__(self, switch_name:str):
        ...
        try:
            ...
            self.enable_logging_throughput = True
            ...
            self.tables = self.controller.get_tables()
            ...
            self.controller.register_write("MyEgress.timestamp", 0, 0)
            ...
            self.controller.register_reset("MyEgress.bytes_counter_malicious_egress")
            ...
            self.controller.register_reset("MyEgress.bytes_counter_benign_egress")
            ...
            entries = self.controller.client.bm_mt_get_entries(0,"MyIngress.cluster_to_prio")
            # print(entries)
            for entry in entries:

                cluster_id = int.from_bytes(entry.match_key[0].exact.key, 'big')
                current_priority = int.from_bytes(entry.action_entry.action_data[0], 'big')
