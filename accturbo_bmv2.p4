...
control MyIngress(
    ...
    table tbl_compute_distance_cluster1_dst0_min {
        ...
        default_action = compute_distance_cluster1_dst0_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster1_dst0_max {
        ...
        default_action = compute_distance_cluster1_dst0_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster1_dst1_min {
        ...
        default_action = compute_distance_cluster1_dst1_min(2);
        size = 512;
    } 
    ...
    table tbl_compute_distance_cluster1_dst1_max {
        ...
        default_action = compute_distance_cluster1_dst1_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster1_dst2_min {
        ...
        default_action = compute_distance_cluster1_dst2_min(2);
        size = 512;
    } 
    ...
    table tbl_compute_distance_cluster1_dst2_max {
        ...
        default_action = compute_distance_cluster1_dst2_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster1_dst3_min {
        ...
        default_action = compute_distance_cluster1_dst3_min(2);
        size = 512;
    } 
    ...
    table tbl_compute_distance_cluster1_dst3_max {
        ...
        default_action = compute_distance_cluster1_dst3_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster2_dst0_min {
        ...
        default_action = compute_distance_cluster2_dst0_min(2);
        size = 512;
    } 
    ...
    table tbl_compute_distance_cluster2_dst0_max {
        ...
        default_action = compute_distance_cluster2_dst0_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster2_dst1_min {
        ...
        default_action = compute_distance_cluster2_dst1_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster2_dst1_max {
        ...
        default_action = compute_distance_cluster2_dst1_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster2_dst2_min {
        ...
        default_action = compute_distance_cluster2_dst2_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster2_dst2_max {
        ...
        default_action = compute_distance_cluster2_dst2_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster2_dst3_min {
        ...
        default_action = compute_distance_cluster2_dst3_min(2);
        size = 512;
    } 
    ...
    table tbl_compute_distance_cluster2_dst3_max {
        ...
        default_action = compute_distance_cluster2_dst3_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst0_min {
        ...
        default_action = compute_distance_cluster3_dst0_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst0_max {
        ...
        default_action = compute_distance_cluster3_dst0_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst1_min {
        ...
        default_action = compute_distance_cluster3_dst1_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst1_max {
        ...
        default_action = compute_distance_cluster3_dst1_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst2_min {
        ...
        default_action = compute_distance_cluster3_dst2_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst2_max {
        ...
        default_action = compute_distance_cluster3_dst2_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst3_min {
        ...
        default_action = compute_distance_cluster3_dst3_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster3_dst3_max {
        ...
        default_action = compute_distance_cluster3_dst3_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst0_min {
        ...
        default_action = compute_distance_cluster4_dst0_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst0_max {
        ...
        default_action = compute_distance_cluster4_dst0_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst1_min {
        ...
        default_action = compute_distance_cluster4_dst1_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst1_max {
        ...
        default_action = compute_distance_cluster4_dst1_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst2_min {
        ...
        default_action = compute_distance_cluster4_dst2_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst2_max {
        ...
        default_action = compute_distance_cluster4_dst2_max(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst3_min {
        ...
        default_action = compute_distance_cluster4_dst3_min(2);
        size = 512;
    }
    ...
    table tbl_compute_distance_cluster4_dst3_max {
        ...
        default_action = compute_distance_cluster4_dst3_max(2);
        size = 512;
    }
    ...
    action do_init_counter(PortId_t port) {
        bit<32> data;
        init_counter.read(data, ig_intr_md.egress_spec);
        bit<8> current_value = 0;
        if (data < (bit<32>)5) {
            current_value = (bit<8>)data;
        }
        data = data + 1;
        init_counter.write(ig_intr_md.egress_spec, data);
    ...
    table tbl_do_init_counter {
        ...
        const default_action = do_init_counter(2);
        size = 512;
    } 
    ...
    action updateclusters_count(out bit<8> current_value) {
        bit<32> data;
        updateclusters_counter.read(data, ig_intr_md.egress_spec);
        current_value = 0;
        ...
        updateclusters_counter.write(ig_intr_md.egress_spec, data);
    }
    ...
    table tbl_do_updateclusters_counter {
        ...
        const default_action = do_updateclusters_counter(2);
        size = 512;
    } 
    ...
    apply {
        ...
        //if (hdr.ipv4.isValid()) {
            ...
            if (ig_intr_md.resubmit_flag == 0){ 
                ...
                ig_intr_md.resubmit_type = 0;

            }

                // Resubmitted packet
                if (meta.rs.update_activated == 1) {
                    PortId_t port = ig_intr_md.egress_spec;
                    if(meta.rs.cluster_id == 1) {
                        bit<32> data;
                        cluster1_dst0_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst0 < data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster1_dst0_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster1_dst0_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst0 > data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster1_dst0_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster1_dst1_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 < data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster1_dst1_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster1_dst1_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 > data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster1_dst1_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster1_dst2_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 < data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster1_dst2_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster1_dst2_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 > data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster1_dst2_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster1_dst3_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 < data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster1_dst3_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster1_dst3_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 > data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster1_dst3_max.write(ig_intr_md.egress_spec, data);
                        }
                        ...
                        if ((bit<32>)hdr.ipv4.dst0 < data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster2_dst0_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster2_dst0_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst0 > data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster2_dst0_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster2_dst1_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 < data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster2_dst1_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster2_dst1_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 > data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster2_dst1_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster2_dst2_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 < data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster2_dst2_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster2_dst2_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 > data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster2_dst2_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster2_dst3_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 < data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster2_dst3_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster2_dst3_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 > data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster2_dst3_max.write(ig_intr_md.egress_spec, data);
                        }
                        ...
                        if ((bit<32>)hdr.ipv4.dst0 < data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster3_dst0_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster3_dst0_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst0 > data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster3_dst0_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster3_dst1_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 < data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster3_dst1_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster3_dst1_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 > data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster3_dst1_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster3_dst2_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 < data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster3_dst2_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster3_dst2_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 > data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster3_dst2_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster3_dst3_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 < data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster3_dst3_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster3_dst3_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 > data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster3_dst3_max.write(ig_intr_md.egress_spec, data);
                        }
                        ...
                        if ((bit<32>)hdr.ipv4.dst0 < data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster4_dst0_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster4_dst0_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst0 > data) {
                            data = (bit<32>)hdr.ipv4.dst0;
                            cluster4_dst0_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster4_dst1_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 < data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster4_dst1_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster4_dst1_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst1 > data) {
                            data = (bit<32>)hdr.ipv4.dst1;
                            cluster4_dst1_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster4_dst2_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 < data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster4_dst2_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster4_dst2_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst2 > data) {
                            data = (bit<32>)hdr.ipv4.dst2;
                            cluster4_dst2_max.write(ig_intr_md.egress_spec, data);
                        }
                        cluster4_dst3_min.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 < data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster4_dst3_min.write(ig_intr_md.egress_spec, data);
                        }
                        cluster4_dst3_max.read(data, port);
                        if ((bit<32>)hdr.ipv4.dst3 > data) {
                            data = (bit<32>)hdr.ipv4.dst3;
                            cluster4_dst3_max.write(ig_intr_md.egress_spec, data);
                        }
...
control MyEgress(
    ...
    action bytes_count_malicious_egress() {
        bit <32> data;
        bytes_counter_malicious_egress.read(data,2);
        data = data + 1;
        bytes_counter_malicious_egress.write(2,data);
    }
    ...
    action bytes_count_benign_egress() {
        bit <32> data;
        bytes_counter_benign_egress.read(data,2);
        data = data + 1;
        bytes_counter_benign_egress.write(2,data);
    }
